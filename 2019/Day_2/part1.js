...
exports.part1 = function (data, a, b) {
    ...
    for (var i = 0; i < data.length; i += 4) {
        var opcode = data[i];
        var inputA = data[data[i + 1]];
        var inputB = data[data[i + 2]];
        var outputIndex = data[i + 3];
        if (opcode === 1) {
            data[outputIndex] = inputA + inputB;
        }
        else if (opcode === 2) {
            data[outputIndex] = inputA * inputB;
        }
...
var res = exports.part1(input, 12, 2);
console.log(res);
